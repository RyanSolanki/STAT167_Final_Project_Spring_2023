...
finalAccident3 <- updatedAccidents3 %>%
filter(City %in% c("Los Angeles"))

#head(updatedAccidents3)
eda1 <- finalAccident3[1:1000, ]

scatter_plot <- ggplot(eda1, (aes(y = Severity, x = Visibility.mi.))) +
  geom_point() +
...
```{r}
#head(updatedAccidents)
eDA2 <- updatedAccidents2[updatedAccidents2$City == 'Los Angeles',]
colnames(eDA2)[5] ="Temperature"

eda2a <- eDA2[1:1000, ]

scatter_plot2 <- ggplot(eda2a, (aes(x = Severity, y = Temperature, colour=Temperature))) +
  geom_point() +
  labs(title = "Severity Vs Temperature",
       x = "Severity",
       y = "Temperature") +
  theme_minimal()
...
scatter_plot3 <- ggplot(eda2b, (aes(x = Severity, y = Traffic_Calming, colour=Traffic_Calming))) +
  geom_point() +
  labs(title = "Severity Vs Traffic Calming",
       x = "Severity",
       y = "Traffic Calming") +
  theme_minimal()
