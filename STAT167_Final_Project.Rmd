...
colnames(updatedAccidents2)[6] ="Temperature.F."
colnames(updatedAccidents2)[8] ="Wind_Speed.mph."
...
```{r}
ggplot(updatedAccidents2, aes(x=Wind_Speed.mph., y=Temperature.F., color=factor(Severity))) +
  geom_point()
```
